<?php
	...
	if ($select_by_belongingid['expiry_date'] == '0000-00-00') $select_by_belongingid['expiry_date'] = "";
...
<body>
	...
	<div class="container">
		<div class="h2 mb-3 mt-3">持ち物詳細</div>
			...
			<div class="h4 card-title m-3"><?php echo h($category_name['category_name']); ?></div>
				<ul class="list-group list-group-flush">
					...
					<li class="list-group-item">使用期限：<?php echo h($select_by_belongingid['expiry_date']); ?></li>
				</ul>
			</div>
			...
			<div class="border col-5 mt-5">
				<form action=<?php echo "https://". h($_SERVER['HTTP_HOST']) . "/user/bg/update/"; ?> method="POST">
					...
					<div class="form-group">
						...
						<div class="mx-3">
							<label for="bgname" class="form-label">持ち物の名称を更新</label>
						...
						<div class="mx-3">
							<label for="expiry" class="form-label">使用期限を更新</label>
